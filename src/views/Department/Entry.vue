<template>
  <v-dialog persistent v-model="dialog" width="50%">
        ...
        <v-card flat>
          <v-col cols="12" md="12" class="mt-8">
            <v-row dense>
              <v-col cols="12" md="12">
                <v-row dense>
                  <v-col cols="12" md="4"><label class="font-weight-regular">Name<span
                        class="text-red">*</span></label></v-col>
                  <v-col cols="12" md="5"><v-text-field v-model="model.name" variant="outlined" density="compact"
                      :rules="namerule"></v-text-field></v-col>
                  <v-col cols="12" md="4"><label class="font-weight-regular">Company Name<span
                        class="text-red">*</span></label></v-col>
                  <v-col cols="12" md="5"><v-autocomplete clearable v-model="model.company_id" item-title='text'
                      item-value='value' variant="outlined" density="compact" :items="companylist"
                      :rules="companyrule"></v-autocomplete></v-col>
                </v-row>
              </v-col>
            </v-row>
          </v-col>
    ...
    import Model from "@/models/department.js";
    ...
    export default {
      ...
      methods: {
        ...
        Show(name) {
          this.dialog = true;
          if (name == "edit") {
            this.formname = "Edit Department Entry";
          }else{
            this.formname = "Department Entry";
          }
        },
        ValidateModel() {
