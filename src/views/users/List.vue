          ...
          <v-col>
              ...
              <v-col cols="12" md="2">
                <v-tooltip location="bottom">
                  <template v-slot:activator="{ props }">
                    ...
                    <!-- <v-btn @click="NewItem" v-bind="props" icon="mdi-plus" color="success" solo></v-btn> -->
                  </template>
              ...
              <v-col cols="12" md="5">
                <v-card-text>
                  <v-text-field :elevation="0" density="compact" v-model="model.name" variant="solo" label="Search"
                    single-line hide-details @click:clear="ResetFilter"
            ...
            <DataTableHelper ref="DataTable" :headers="headers" :dataLoader="GetAllData" :show_select=false
              ...
              <template v-slot:[`item.id`]="{ item }">
                ...
                <v-btn variant="text" icon size="x-small" @click="ShowPasswordReset(item)"
                  color="secondary"><v-icon>mdi-lock-reset</v-icon>
            ...
            <!-- <PasswordReset @fterSaved="ResetFilter " ref="PasswordResetModal" /> -->
          </v-col>
        </v-card>
