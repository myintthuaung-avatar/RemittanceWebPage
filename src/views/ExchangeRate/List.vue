<template>
  <v-container>
    ...
    import Model from "@/models/exchangerate";
      ...
      data() {
        return {
          ...
          { title: 'Actions', width:140, key: 'id'},
            ...
            { title: 'Buy Rate', key: 'buy', width:220},
            { title: 'Sell Rate', key: 'sell',width:220 },
            { title: 'Created Date', key: 'created_date', width:220},
            { title: 'Created By', key: 'created_name',width:220 },
