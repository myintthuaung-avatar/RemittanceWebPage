...
import Service from "@/services/dailyinwardremittance.service.js";
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { title: 'ReceiverName', key: 'receiver_name', width: 220 },
        { title: "ReceiverNRC/Passport", key: 'receiver_nrcpassport', width: 350 },
        { title: "Receiver'sAddress", key: 'receiver_address', width: 350 },
        { title: "Receiver'sPhone no", key: 'receiver_phoneno', width: 350},
        { title: 'PurposeofTransaction', key: 'purpose_transaction', width: 220 },
        { title: 'Payment', key: 'payment_type', width: 220 },
        { title: "Sender'sName", key: 'sender_name', width: 220 },
        { title: "Sender'sCountry", key: 'sender_countryname', width: 220 },
        { title: 'Currency', key: 'currency', width: 220 },
        { title: 'DepositAmount', key: 'deposit_amount', width: 220 },
    ...
    ExcelReport() {
      ...
      return new Promise(() => {
        Service.DownLoadReport(vm.model, { itemsPerPage: -1 }).then(response => {
          ...
          fileLink.href = url;
          fileLink.setAttribute("download", "DailyInwardStatement.xls");
