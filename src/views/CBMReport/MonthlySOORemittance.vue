<template>
  <div>
    <v-col cols="12" md="12">
      <h4>
       Monthly Service OutWard Remittance 
      </h4>
      <v-col cols="12" md="12">
...
import Service from "@/services/monthlysooremittance.service.js";
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { title: "RemittanceAmount By Monthly", key: 'mmk', width: 350 , sortable:false,
        children: [
            { title: 'MMK', key: 'mmk', width: 220 },
            { title: 'THB', key: 'thb', width: 220 },
            { title: 'Other', key: 'dd', width: 220 },
          ],
        },
        { title: "Total Remittance Amount", key: 'mmk', width: 350 , sortable:false,
        children: [
            { title: 'Total(MMK)', key: 'total_mmk', width: 220 },
            { title: 'Total(THB)', key: 'total_thb', width: 220 },
            { title: 'Total(Other)', key: 'total_dd', width: 220 },
          ],
        },
      ],
    };
    ...
    ExcelReport() {
      ...
      return new Promise(() => {
        Service.DownLoadReport(vm.model, { itemsPerPage: -1 }).then(response => {
          ...
          fileLink.href = url;
          fileLink.setAttribute("download", "Monthly SOO Remittance.xls");
